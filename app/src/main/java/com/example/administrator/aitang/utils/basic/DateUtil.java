...
public class DateUtil {
     ...
     *
     * @param l 时间戳
     * @param s 要转换的时间格式：yyyy-MM-dd HH:mm:ss
     * @return 时间
     */
    public static String toString(long l, String s) {
...
//        return d;
    ...
    //时间戳转化为Date
    public static Date toData(long l, String s) {
        SimpleDateFormat format = new SimpleDateFormat(s);
        Long time = new Long(l);
        String d = format.format(time);
        Date date = null;
     ...
     * @return
     */
    public static long toL(String time, String s) {
     ...
     * @return
     */
    public static long toL(Date date, String s) {
        SimpleDateFormat format = new SimpleDateFormat(s);
        return date.getTime();
    }
}
