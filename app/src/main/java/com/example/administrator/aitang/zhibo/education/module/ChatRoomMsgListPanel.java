package com.example.administrator.aitang.zhibo.education.module;
...
import com.example.administrator.aitang.zhibo.education.viewholder.ChatRoomMsgViewHolderFactory;
...
import com.example.administrator.aitang.zhibo.im.session.adapter.MsgAdapter;
import com.example.administrator.aitang.zhibo.im.session.viewholder.MsgViewHolderBase;
import com.example.administrator.aitang.zhibo.im.ui.dialog.EasyAlertDialog;
import com.example.administrator.aitang.zhibo.im.ui.dialog.EasyAlertDialogHelper;
import com.example.administrator.aitang.zhibo.im.ui.listview.AutoRefreshListView;
import com.example.administrator.aitang.zhibo.im.ui.listview.ListViewUtil;
import com.example.administrator.aitang.zhibo.im.ui.listview.MessageListView;
...
//        MessageAudioControl.getInstance(container.activity).stopAudio(); // 界面返回，停止语音播放
    ...
    private void initListView() {
        ...
        // TODO: 2017/12/9 设置上拉下拉的刷新监听，如果有需要可以打开
