package com.example.administrator.aitang.zhibo.im.activity;
...
import com.example.administrator.aitang.zhibo.base.util.string.MD5;
...
import com.example.administrator.aitang.zhibo.im.ui.widget.ClearableEditTextWithIcon;
...
//        final String token = tokenFromPassword(loginPasswordEdit.getEditableText().toString());
        final String account="54";
        final String token="336bb9adc5d8e8e679fd1dd417ec79a8";
        // 登录
...
//                Toast.makeText(LoginActivity.this, "这是LoginActivity里的吐司", Toast.LENGTH_SHORT)
//                        .show();
//
//                DialogMaker.dismissProgressDialog();
//            }
