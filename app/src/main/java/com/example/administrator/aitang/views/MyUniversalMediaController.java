...
public class MyUniversalMediaController extends FrameLayout {


    private MyUniversalMediaController.MediaPlayerControl mPlayer;
...
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    public SeekBar.OnSeekBarChangeListener setSeekLister;

    public void setSetSeekLister(SeekBar.OnSeekBarChangeListener setSeekLister) {
        this.setSeekLister = setSeekLister;
    }
    ...
    private SeekBar.OnSeekBarChangeListener mSeekListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onStartTrackingTouch(SeekBar bar) {
            ...
            mDragging = true;
            mHandler.removeMessages(SHOW_PROGRESS);
            setSeekLister.onStartTrackingTouch(bar);
        }
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            change = true;
            setSeekLister.onProgressChanged(bar, progress, fromuser);
        }
        ...
        public void onStopTrackingTouch(SeekBar bar) {
            ...
            mShowing = true;
            mHandler.sendEmptyMessage(SHOW_PROGRESS);
            setSeekLister.onStopTrackingTouch(bar);
        }
    };
