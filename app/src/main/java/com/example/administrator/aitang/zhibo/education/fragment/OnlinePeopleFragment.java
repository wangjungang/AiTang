...
import com.example.administrator.aitang.zhibo.base.ui.TViewHolder;
import com.example.administrator.aitang.zhibo.education.adapter.OnlinePeopleAdapter;
import com.example.administrator.aitang.zhibo.education.helper.ChatRoomMemberCache;
import com.example.administrator.aitang.zhibo.education.helper.SimpleCallback;
import com.example.administrator.aitang.zhibo.education.helper.VideoListener;
import com.example.administrator.aitang.zhibo.education.viewholder.OnlinePeopleViewHolder;
import com.example.administrator.aitang.zhibo.im.ui.ptr.PullToRefreshBase;
import com.example.administrator.aitang.zhibo.im.ui.ptr.PullToRefreshListView;
...
public class OnlinePeopleFragment extends TFragment implements TAdapterDelegate, VideoListener {
    ...
    public void onCurrent() {
        clearCache();
        roomId = ((ZhiboActivity) getActivity()).getRoomInfo().getRoomId();
        fetchData();
    ...
    private void addMembers(List<ChatRoomMember> members) {
        for (ChatRoomMember member : members) {
            ...
            OnlinePeopleAdapter.OnlinePeopleItem item = new OnlinePeopleAdapter.OnlinePeopleItem(((ZhiboActivity) getActivity()).getRoomInfo().getCreator(),
                    member);
    ...
    ChatRoomMemberCache.MeetingControlObserver meetingControlObserver = new ChatRoomMemberCache.MeetingControlObserver() {
        ...
        public void onAccept(String roomID) {
            Log.d("TAG", "onlinePeopleFrg--accept()");
            if (checkRoom(roomID)) {
                return;
            }
            adapter.notifyDataSetChanged();
    ...
    public void onUserLeave(String account) {
        logd("onlinepeoplefragment--onuserleave");
    }
