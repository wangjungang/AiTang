...
public class MyUniversalVideoView extends SurfaceView
        implements MyUniversalMediaController.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    ...
    public void setMediaController(MyUniversalMediaController controller) {
